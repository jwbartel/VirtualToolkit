...
public class SwingProgressBarEventForwarder implements ActionListener {
	SwingProgressBar component;

	public SwingProgressBarEventForwarder(SwingProgressBar b) {
		component = b;
	}
