...
public class ADistributedSWTSmallUICreator {
	public static void main(String args[]) {
		WidgetServerSelector.setWidgetServerFactory(new ADistributedNonGwtRmiWidgetServerFactory());
		VirtualToolkit.setDefaultToolkit(new SWTToolkit("127.0.0.1:15151/~translator/?session=test1&kind=small", true, true));
